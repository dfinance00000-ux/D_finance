...
import { load } from "@cashfreepayments/cashfree-js"; // 🔥 NPM Package for SDK
  ...
  const handleOnlinePayment = async () => {
    ...
    try {
      ...
      let checkoutOptions = {
        ...
        redirectTarget: "_modal", // Isse popup khulega portal ke upar
      };
      ...
      cashfree.checkout(checkoutOptions).then((result) => {
        ...
        // Payment success/failure ke baad data refresh karo
        onRefresh();
      });
    ...
    <div style={overlayStyle}>
      ...
      <div style={modalCard} className="modal-animate">
        ...
        <div style={bodyContent}>
          ...
          {/* --- 💳 ONLINE SECTION (OFFICIAL SDK BUTTON) --- */}
          {payMode === 'online' ? (
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                  ...
                  >
                    ...
                    <div style={btnTextWrapper}>
                      <div style={btnMainText}>{loading ? "Processing..." : "Pay with Cashfree"}</div>
